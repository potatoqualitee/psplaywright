function Save-PSPScreenshot {
    ...
    .EXAMPLE
        Save-PSPScreenshot -Uri https://www.google.com -Path C:\temp

        Takes a screenshot of the Google homepage and saves it to C:\Temp\www.google.com.png.

    .EXAMPLE
        Save-PSPScreenshot -Uri https://www.google.com, bbc.com -Path C:\temp
    ...
    process {
        ...
        Invoke-PSPNode -FilePath $screenshots -ArgumentList $json
